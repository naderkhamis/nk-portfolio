                ...
                <div class="card card-warning card-outline col-md-5 col-lg-4 bg-dark">
                    ...
                    <div class="card-body box-profile">
                        ...
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="{{ asset($personal_information->image) }}"
                                alt="User profile picture">
                        </div>
                        <!-- /Image -->

                        <h3 class="profile-username text-center">{{ $personal_information->name }}</h3>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item bg-dark">
                                <b>Nationality</b> <a class="float-right">{{ $personal_information->nationality }}</a>
                            </li>
                            <li class="list-group-item bg-dark">
